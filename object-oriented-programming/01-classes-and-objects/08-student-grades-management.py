...
# Explanation:
# Let's start by creating our Student class. In Python, we use the 'class' keyword 
...
# - Created the basic Student class structure
...
# Step 4: Add the add_grade method
# ===============================================================================

# Explanation:
# Now let's add the add_grade method that adds a new grade to the student's grades list.
# This method will modify the grades attribute we defined earlier.
...
# What we accomplished in this step:
# - Added the add_grade method to add grades to the list


# Step 5: Add the average_grade method
# ===============================================================================

# Explanation:
# Now let's add the average_grade method that calculates the average of all grades.
# This method includes a check to avoid division by zero if no grades exist.
...
# What we accomplished in this step:
# - Added the average_grade method with division by zero protection
...
# What we accomplished in this step:
# - Created and tested our complete Student implementation
