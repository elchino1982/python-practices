...
# Explanation:
# Let's start by creating our Person class. In Python, we use the 'class' keyword 
...
# - Created the basic Person class structure
...
# Step 4: Add the greet method
# ===============================================================================

# Explanation:
# Now let's add the greet method that prints a greeting message including the person's name.
# This method will use the attributes we defined earlier.
...
# What we accomplished in this step:
# - Added the greet method with its functionality
...
# What we accomplished in this step:
# - Created and tested our complete Person implementation
