"""Question: Implement the Builder pattern for constructing complex objects step by step.

Create a computer builder that can construct different types of computers (Gaming, Office, Server)
with various components (CPU, RAM, Storage, Graphics) using a step-by-step approach.

Requirements:
1. Create a Computer class with multiple components
2. Implement abstract Builder class
3. Create concrete builders for different computer types
4. Implement Director class to orchestrate building process
5. Demonstrate fluent interface for building
6. Show how different configurations can be built

Example usage:
    director = ComputerDirector()
    gaming_builder = GamingComputerBuilder()
    gaming_pc = director.build_computer(gaming_builder)
"""
...
if __name__ == "__main__":
    ...
    # Demonstrate fluent interface with extras
    print("4. Gaming Computer with Extras:")
    gaming_builder_with_extras = GamingComputerBuilder()
    gaming_builder_with_extras.add_extra("RGB Lighting Kit")
    gaming_builder_with_extras.add_extra("Mechanical Gaming Keyboard")
    gaming_builder_with_extras.add_extra("Gaming Mouse")
    gaming_computer_with_extras = director.build_computer(gaming_builder_with_extras)
    print(gaming_computer_with_extras)
...
# - Added example with extra components
